...
Properties
{
	...
	_FullbrightCutoff ("_Fullbright Cutoff", Range(0,1)) = .5
}
...
void surf (Input IN, inout EditorSurfaceOutput o)
{
	...
	fixed4 rc = tex2Dproj(_RenderTexture, IN.screenPos);
	float brightness = sqrt((rc.r + rc.g + rc.b)/3);
	if(brightness > _FullbrightCutoff) brightness = 1;
	else brightness = brightness / _FullbrightCutoff;

    o.Emission = Multiply3.xyz * _Color.rgb * brightness;
	

	
    o.Alpha =  Multiply3.w * _Color.a * brightness;
