...
public class NetworkManager : MonoBehaviour {
	...
	void spawnShip() {
		GameObject newShip;
		if (multiplayerEnabled)
			newShip = (GameObject)Network.Instantiate (Resources.Load ("Fighter"), Vector3.zero, Quaternion.identity, 0);
		else
			newShip = (GameObject)Instantiate (Resources.Load ("Fighter"), Vector3.zero, Quaternion.identity);
